...
Before we can begin an **R** workshop, we need to make sure everyone has access to a computer with [R](http://cran.r-project.org) and [RStudio](https://posit.co/) installed. The process for how to do this is detailed below, followed by a brief introduction to why we use these two pieces of software and what the difference is between them.
...
We will go into this in more detail in [R Workflow - I](https://face-it-project.github.io/R_workshop/workflow.html#r-workflow---i).
...
-   [bookdown: Authoring Books and Technical Documents with R](https://bookdown.org/yihui/bookdown) --- writing books in R
-   [Shiny](https://shiny.rstudio.com) --- interactive web apps driven by R
...
::: slides
[Slides](https://face-it-project.github.io/R_workshop/course_material/_slides/intro_1_base.html)
:::

::: source
[Source](https://github.com/FACE-IT-project/R_workshop/tree/main/course_material/_slides/intro_1_base.qmd)
:::
:::
